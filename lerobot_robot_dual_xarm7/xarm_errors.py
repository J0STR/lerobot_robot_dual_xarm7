# from: https://github.com/xArm-Developer/xArm-Python-SDK/blob/master/doc/api/xarm_api_code.md
...
errors = {
    ...
    -3: "reversed, no use",
    -2: "xArm is not ready, may be the motion is not enabled or not set state",
...
# ---
six_axis_force_torque_sensor_error_codes = {
